            ...
            <div class="intro-x dropdown w-8 h-8">
                ...
                <div class="dropdown-menu w-56">
                    <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                        ...
                        <li>
                            <a href="<?= site_url('chat') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> Chat Admin </a>
                        </li>
                        <li>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= site_url('chat') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="message-square"></i> </div>
                            <div class="side-menu__title"> Chat ke Admin </div>
                        </a>
                    </li>
                     <!-- Tambahkan di mana saja dalam tampilan utama -->
                    <!-- <a href="<?= site_url('chat'); ?>" class="btn btn-chat">Chat dengan Admin</a> -->
                </ul>
            </nav>
            <!-- END: Side Menu -->