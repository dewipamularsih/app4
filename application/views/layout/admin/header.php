            ...
            <div class="intro-x dropdown w-8 h-8">
                ...
                <div class="dropdown-menu w-56">
                    <ul class="dropdown-content bg-primary/80 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                        ...
                        <li>
                            <a href="<?= site_url('admin/profile_admin') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="user" class="w-4 h-4 mr-2"></i> My Profile </a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/chat') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="message-square" class="w-4 h-4 mr-2"></i> Chat Admin </a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/product') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="shopping-bag" class="w-4 h-4 mr-2"></i> Product </a>
                        </li>
                        <li>
                            <a href="<?= site_url('admin/invoice') ?>" class="dropdown-item hover:bg-white/5"> <i data-lucide="file-text" class="w-4 h-4 mr-2"></i> Invoice </a>
                        </li>
        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= site_url('admin/chat') ?>" class="side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('admin/profile_admin') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="settings"></i> </div>
                            <div class="side-menu__title"> Settings </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('admin/change_password') ?>" class="side-menu">
