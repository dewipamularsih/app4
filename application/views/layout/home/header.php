        ...
        <div class="wrapper-box">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/hewan_qurban') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Hewan </div>
                        </a>
                    </li>
                   

                    <li>
                        <a href="<?= base_url('categories/perlengkapan_qurban') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Perlengkapan </div>
                        </a>
                    </li>
