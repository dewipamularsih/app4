<div class="content">
    ...
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        ...
        <div class="intro-y col-span-11 alert alert-primary alert-dismissible show flex items-center mb-6" role="alert">
            ...
            <span>Starting June 10, 2024, there will be changes to the Terms & Conditions regarding the number of products that may be added by the Seller. <a href="https://themeforest.net/item/midone-jquery-tailwindcss-html-admin-template/26366820" class="underline ml-1" target="blank">Learn More</a></span>
                    ...
                    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                        ...
                        <div class="mt-5">
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="product-name" type="text" name="nama_brgqurban" class="form-control" placeholder="Product name">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <select id="category" name="kategori" class="form-select">
                                        ...
                                        <option value="Hewan Qurban">Hewan</option>
                                        <option value="Perlengkapan Qurban">Perlengkapan</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
