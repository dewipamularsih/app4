                   ...
                   <tbody>
                       <?php foreach ($product as $row) : ?>
                           <tr class="intro-x">
                               ...
                               <td class="whitespace-nowrap"> <a class="flex items-center underline decoration-dotted" href="javascript:;"><?= $row->nama_brgqurban ?></a> </td>
                               ...
                               <td class="table-report__action w-56">
                                   <div class="flex justify-center items-center">
                                       ...
                                       <a class="flex items-center text-danger" href="<?= site_url('admin/product/delete/' . $row->id_brg) ?>" onclick="return confirm('Anda Ingin Menghapus Product Ini ? Klik Ok')"> <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
                                   </div>
                               </td>
                           </tr>
                       <?php endforeach; ?>
